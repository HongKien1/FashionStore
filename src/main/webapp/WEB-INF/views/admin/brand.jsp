                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive mt-5">
                            <a href="/admin/brand/addBrand">
                                <button type="submit" class="btn btn-info float-end" style="margin-right: 70px">Thêm
                                </button>
                            </a>
                            <h5 class="fw-bold py-3 mb-4">Danh sách thương hiệu</h5>
    ...
    function confirmDelete(brandId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = '/admin/brand/deleteBrand/' + brandId;
            }
        })
    }
</script>
