			...
			<div class="row">
						...
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
								...
								<tr class="table_row">
									...
									<td class="column-3">20.000 VNĐ</td>
									<td class="column-4">
									...
									<td class="column-5">20.000 VNĐ</td>
								</tr>

								<tr class="table_row">
									<td class="column-1">
										<div class="how-itemcart1">
											<img src="/user/images/item-cart-05.jpg" alt="IMG">
										</div>
									</td>
				...
				<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
						...
						<a href="/orderDetail" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">
							Mua hàng
						</a>
					</div>
				</div>
